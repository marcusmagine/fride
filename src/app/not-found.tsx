...
export default function NotFound() {
  return (
    <section className="min-h-[60vh] flex flex-col items-center justify-center px-6 py-24 text-center">
      ...
      <h1 className="font-serif text-4xl md:text-5xl font-semibold text-[#20293d] mb-4">
        Sidan hittades inte
      </h1>
      <p className="text-[#515b73] text-lg mb-10 max-w-md">
        Sidan du letar efter verkar inte finnas. Den kan ha flyttats eller tagits bort.
      </p>
      <Link
        href="/"
        className="bg-[#20293d] text-[#fff1e6] px-6 py-3 rounded-full text-sm font-medium hover:bg-[#3A4A6E] transition-colors"
      >
