...
const staticRoutes: MetadataRoute.Sitemap = [
  ...
  { url: `${BASE_URL}/framtidsklar`, changeFrequency: "monthly", priority: 0.8 },
  { url: `${BASE_URL}/framtidsklar/sambor`, changeFrequency: "monthly", priority: 0.7 },
  { url: `${BASE_URL}/framtidsklar/gift`, changeFrequency: "monthly", priority: 0.7 },
  { url: `${BASE_URL}/framtidsklar/ensamstaende`, changeFrequency: "monthly", priority: 0.7 },
